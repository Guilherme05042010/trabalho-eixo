...
function LeiaMais9(){
    ...
    var maisTexto9=document.getElementById("mais9")
    var btnLeiaMais9=document.getElementById("btnLeiaMais9")

    if(pontos9.style.display === "none"){
        pontos9.style.display="inline";
        maisTexto9.style.display="none";
        btnLeiaMais9.innerHTML="▼"
    }else{
...
function LeiaMais10(){
    ...
    var maisTexto10=document.getElementById("mais10")
    var btnLeiaMais10=document.getElementById("btnLeiaMais10")

    if(pontos10.style.display === "none"){
        pontos10.style.display="inline";
        maisTexto10.style.display="none";
        btnLeiaMais10.innerHTML="▼"
    }else{
...
function LeiaMais11(){
    ...
    var maisTexto11=document.getElementById("mais11")
    var btnLeiaMais11=document.getElementById("btnLeiaMais11")

    if(pontos11.style.display === "none"){
        pontos11.style.display="inline";
        maisTexto11.style.display="none";
        btnLeiaMais11.innerHTML="▼"
    }else{
...
function LeiaMais12(){
    ...
    var maisTexto12=document.getElementById("mais12")
    var btnLeiaMais12=document.getElementById("btnLeiaMais12")

    if(pontos12.style.display === "none"){
        pontos12.style.display="inline";
        maisTexto12.style.display="none";
        btnLeiaMais12.innerHTML="▼"
    }else{
...
function LeiaMais13(){
    ...
    var maisTexto13=document.getElementById("mais13")
    var btnLeiaMais13=document.getElementById("btnLeiaMais13")

    if(pontos13.style.display === "none"){
        pontos13.style.display="inline";
        maisTexto13.style.display="none";
        btnLeiaMais13.innerHTML="▼"
    }else{
...
function LeiaMais14(){
    ...
    var maisTexto14=document.getElementById("mais14")
    var btnLeiaMais14=document.getElementById("btnLeiaMais14")

    if(pontos14.style.display === "none"){
        pontos14.style.display="inline";
        maisTexto14.style.display="none";
        btnLeiaMais14.innerHTML="▼"
    }else{
